...
Hexadecimal [16-Bits]
                              ...
                              6 
                              7 ;; Global Symbols
   42A4 00                    8 e_type_invalid::  .db 0x00
   42A5 01                    9 e_type_star::     .db 0x01
   42A6 80                   10 e_type_dead::     .db 0x80
   42A7 7F                   11 e_type_default:  .db 0x7F
   42A8 00 00                12 where_I_am:     .dw #0x0000 
   42AA 00 00                13 auxDW:        .dw #0x0000
                             14 
                             15 ;; Entity Values
   42AC 00                   16 entity_type:      .db  #00      ;;Type of the Entity
   42AD 4F                   17 entity_x::        .db  #79       ;; X(horizontal) value
   42AE 50                   18 entity_y::         .db  #80       ;; Y(vertical) Value
   42AF 01                   19 entity_vx::        .db  #1      ;; VX Speed value
   42B0 FF                   20 entity_color::     .db  #0xFF       ;; COlor
   42B1 FF                   21 entity_prevptr::   .db  #0xFF      ;; Last position of the Entity drawed
                             22 
   42B2 00 00                23 last_entity_pos_entities::  .dw  #0x0000
                             24 
   42B4 0A                   25 num_entities::    .db  #10
   42B5                      26 entities::       .ds  #60      ;;Array of 10 Entities (all 0 values) 6 spaces for entity || 1 for value
                             27 
                             28 
                             29 
                             30 .globl man_init_entity
                             31 .globl man_create_entity
                             32 .globl man_destroy_entity
                             33 
                             34 .globl sys_generator_newStar
                             35 .globl _main
                             36 ;; 
                             37 .area _CODE
                             38 
                             ...
                             42 ;;
                             43 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   401C                      44 man_init_entity:
   401C 21 B4 42      [10]   45    ld    hl, #num_entities+0        ;; paso direccion de memoria a HL de numero de entidades
   401F 36 00         [10]   46    ld    (hl),#0x00                 ;; pongo el valor de num entities a 0
   4021 21 B5 42      [10]   47    ld    hl, #entities
   4024 22 B2 42      [16]   48    ld    (last_entity_pos_entities),  hl;; guardo la posicion inicial de entities en last_pos
   4027 C9            [10]   49 ret
                             50 
                             51 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             52 ;;                CREATE NEW ENTITY
                             53 ;;
                             54 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   4028                      55 man_create_entity:
                             56         ;; (hl) == 425f  hl =4254
   4028 D5            [11]   57         push de
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 51.
Hexadecimal [16-Bits]



   4029 5E            [ 7]   58         ld e, (hl)
   402A 23            [ 6]   59         inc hl
   402B 56            [ 7]   60         ld d, (hl)
   402C EB            [ 4]   61         ex de, hl
   402D D1            [10]   62         pop de
                             63 
                             64         
   402E 7E            [ 7]   65         ld a, (hl)
   402F FE 00         [ 7]   66         cp  #0
   4031 28 11         [12]   67         jr z,jumpy
                             68     
   4033 79            [ 4]   69         ld a, c                 ;;C values the TYpe Star
   4034 FE 01         [ 7]   70         cp #1
   4036 28 04         [12]   71         jr  z, its_a_star           ;;if its a star dont change the C value
   4038 3A A7 42      [13]   72         ld a,(e_type_default)
   403B 4F            [ 4]   73         ld c, a                     ;; its not a star puts the 
   403C                      74         its_a_star:
                             75        
                             76         
   403C 2A B2 42      [16]   77       ld    hl, (last_entity_pos_entities)           ;; load to hl the next position of entities
   403F 7E            [ 7]   78       ld    a, (hl)
   4040 FE 00         [ 7]   79       cp    #0
   4042 20 1C         [12]   80       jr    nz, position_with_entity
   4044                      81       jumpy:
   4044 79            [ 4]   82       ld    a, c            ;; 1st place get the type of the entity
   4045 77            [ 7]   83       ld    (hl), a
   4046 23            [ 6]   84       inc   hl                              ;; increase the memory ptr to 2nd place
   4047 3A AD 42      [13]   85       ld    a,(entity_x)                    
   404A 77            [ 7]   86       ld    (hl),a                          ;; add the X position on 2nd place
   404B 23            [ 6]   87       inc   hl
   404C 7B            [ 4]   88       ld    a, e                            ;; recieve the random number generated for 0-199 (negative)
   404D 77            [ 7]   89       ld    (hl),a                          ;; and add it to the 3rd place for the height
   404E 23            [ 6]   90       inc   hl
   404F 78            [ 4]   91       ld    a, b                            ;; B is a random speed from -3,-1
   4050 77            [ 7]   92       ld    (hl), a                         ;; added to the the 4th place
   4051 23            [ 6]   93       inc   hl
   4052 3A B0 42      [13]   94       ld    a, (entity_color)               ;; color for the 5th place
   4055 77            [ 7]   95       ld    (hl),a
   4056 23            [ 6]   96       inc   hl
   4057 3A B1 42      [13]   97       ld    a, (entity_prevptr)             ;; last place he was to delete
   405A 77            [ 7]   98       ld    (hl),a
   405B 23            [ 6]   99       inc   hl
                            100                  ;; last position have now the next entity position
   405C 21 B4 42      [10]  101       ld    hl,#num_entities                    
   405F 34            [11]  102       inc   (hl)                             ;; increase the num_entities
                            103 
                            104     
                            105 
   4060                     106     position_with_entity:
   4060 2A B2 42      [16]  107     ld    hl, (last_entity_pos_entities)
                            108     .rept 6
                            109         inc hl
                            110     .endm
   4063 23            [ 6]    1         inc hl
...
Hexadecimal [16-Bits]
   ...
   4067 23            [ 6]    1         inc hl
   4068 23            [ 6]    1         inc hl
   4069 22 B2 42      [16]  111     ld    (last_entity_pos_entities), hl
   406C C9            [10]  112 ret
                            113 ;;
                            114 
                            115 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            118 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            119 
   406D                     120 man_destroy_entity:
   406D 21 B5 42      [10]  121 ld  hl, #entities
   4070 22 A8 42      [16]  122     ld (where_I_am),hl
   4073 7D            [ 4]  123     ld a,l
   4074 C6 36         [ 7]  124     add #54
   4076 6F            [ 4]  125     ld l, a
   4077 EB            [ 4]  126     ex de, hl
   4078                     127         jumpdestroy:
   4078 01 00 00      [10]  128         ld   bc, #0x0000
   407B ED 4B A8 42   [20]  129         ld   bc, (where_I_am)
   407F DD 21 00 00   [14]  130         ld   ix, #0x000
   4083 DD 09         [15]  131         add  ix, bc 
                            132 
   4085 DD 7E 00      [19]  133         ld  a, (ix)
   4088 FE 80         [ 7]  134         cp #0x80
   408A 20 0B         [12]  135         jr nz, doitdestroy
   408C 3E 00         [ 7]  136             ld a, #0x00
   408E DD 77 00      [19]  137             ld (ix), a
   4091 21 B4 42      [10]  138             ld hl, #num_entities
   4094 35            [11]  139             dec (hl)
                            140             
   4095 18 15         [12]  141             jr finishdestroy
   4097                     142         doitdestroy:
                            143 
                            144 
   4097 21 A8 42      [10]  145         ld hl, #where_I_am
                            146         .rept 6
                            147             inc (hl)
                            148         .endm
   409A 34            [11]    1             inc (hl)
   ...
   409F 34            [11]    1             inc (hl)
                            149 
                            150 
   40A0 ED 4B A8 42   [20]  151     ld bc, (where_I_am)
   40A4 79            [ 4]  152     ld  a, c
   40A5 BB            [ 4]  153     cp  e               ;;#checking if "WIam" is the same,
                            154                                     ;; that means i am in already updated
                            155                                     ;; the last entity
...
Hexadecimal [16-Bits]
   ...
   40A6 20 D0         [12]  156     jr  nz, jumpdestroy                    ;; if i am not in the last entity, do next entity
                            157 
   40A8 78            [ 4]  158     ld a, b
   40A9 BA            [ 4]  159     cp d
   40AA 20 CC         [12]  160     jr nz, jumpdestroy                     ;; checking if last entity and where i am in same place, finishes the update
                            161                                     ;; Loop of all entities
                            162     
                            163 
                            164 
                            165 
                            166 
                            167 
   40AC                     168     finishdestroy:
                            169 
   40AC C9            [10]  170 ret
                            171 
                            172 
                            173 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            174 ;;                Set 4 Destruction
                            175 ;;
                            176 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            177 
   40AD                     178 man_set4Destruction_entity::
   40AD 3E 00         [ 7]  179         ld  a, #0x00        
   40AF DD 77 04      [19]  180         ld  +4(ix),a        ;; color of the entity to white, will clear all the last positions of the entity
   40B2 DD 77 01      [19]  181         ld  +1(ix),a
                            182         
   40B5 DD 77 03      [19]  183         ld  +3(ix),a
                            184         
   40B8 3A A6 42      [13]  185         ld a, (e_type_dead) 
   40BB DD 77 00      [19]  186         ld (ix), a      ;; change the type of the entity to errase the entity from the array
                            187         
                            188     
                            189 
   40BE 06 FF         [ 7]  190         ld b, #0xFF             ;; return FF for the to not move the X position of the entity
   40C0 C9            [10]  191 ret
                            192 
                            193 
                            194 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            196 ;;
                            197 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   40C1                     198 man_free_entity::
                            199 
                            200 
   40C1 3A B4 42      [13]  201     ld    a, (num_entities)             ;; meto en a lo que valga num entities para saber cuanto vale num entities
   40C4 FE 0A         [ 7]  202     cp    #10                           ;; compruebo si hay 10 entidades
   40C6 28 03         [12]  203     jr    z, entity_create_pausa        ;; si hay 10 entidades salgo del metodo
                            204 
   40C8 CD 12 41      [17]  205     call sys_generator_newStar           ;; there is enough space and create a new Star
                            206 
   40CB                     207     entity_create_pausa:     ;;leave the method
   40CB C9            [10]  208 ret
                            209 
                            210 
...
Hexadecimal [16-Bits]
   ...
   40CC                     211 man_search_for_space::
   40CC 21 B5 42      [10]  212     ld  hl, #entities
   40CF 22 A8 42      [16]  213     ld (where_I_am),hl
   40D2 7D            [ 4]  214     ld a,l
   40D3 C6 36         [ 7]  215     add #54
   40D5 6F            [ 4]  216     ld l, a
   40D6 EB            [ 4]  217     ex de, hl
   40D7                     218         jumpsearch:
   40D7 01 00 00      [10]  219         ld   bc, #0x0000
   40DA ED 4B A8 42   [20]  220         ld   bc, (where_I_am)
   40DE DD 21 00 00   [14]  221         ld   ix, #0x000
   40E2 DD 09         [15]  222         add  ix, bc 
                            223 
   40E4 DD 7E 00      [19]  224         ld  a, (ix)
   40E7 FE 00         [ 7]  225         cp #0x00
   40E9 20 0E         [12]  226         jr nz, doit
   40EB 21 A8 42      [10]  227             ld  hl, #(where_I_am)
   40EE E5            [11]  228             push hl
   40EF 5E            [ 7]  229                ld e, (hl)
   40F0 23            [ 6]  230                inc hl
   40F1 56            [ 7]  231                ld d, (hl)
   40F2 EB            [ 4]  232                ex de, hl
   40F3 22 B2 42      [16]  233             ld (last_entity_pos_entities), hl
   40F6 E1            [10]  234             pop hl
   40F7 18 15         [12]  235             jr finish
   40F9                     236         doit:
                            237 
                            238 
   40F9 21 A8 42      [10]  239         ld hl, #where_I_am
                            240         .rept 6
                            241             inc (hl)
                            242         .endm
   40FC 34            [11]    1             inc (hl)
   ...
   4101 34            [11]    1             inc (hl)
                            243 
                            244 
   4102 ED 4B A8 42   [20]  245     ld bc, (where_I_am)
   4106 79            [ 4]  246     ld  a, c
   4107 BB            [ 4]  247     cp  e               ;;#checking if "WIam" is the same,
                            248                                     ;; that means i am in already updated
                            249                                     ;; the last entity
   4108 20 CD         [12]  250     jr  nz, jumpsearch                    ;; if i am not in the last entity, do next entity
                            251 
   410A 78            [ 4]  252     ld a, b
   410B BA            [ 4]  253     cp d
   410C 20 C9         [12]  254     jr nz, jumpsearch                     ;; checking if last entity and where i am in same place, finishes the update
                            255                                     ;; Loop of all entities
                            256     
                            257 
                            258 
                            259 
