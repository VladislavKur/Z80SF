...
Hexadecimal [16-Bits]
                              ...
                              3 
                              4 .area _DATA
   42F1 FF FF                 5 where_to_draw:  .dw #0xffff              ;; place where i will draw
   42F3 00 00                 6 where_I_am:     .dw #0x0000                ;; this one is for move for the entities array calculating
   42F5 FF                    7 pos_x:          .db #0xFF
   42F6 FF                    8 pos_y:          .db #0xFF
   42F7 FF                    9 color:          .db #0xFF
   42F8 FF                   10 prevptr:        .db #0xFF
                             11 
                             12 .globl cpct_disableFirmware_asm
                             13 .globl cpct_getScreenPtr_asm
                             14 .globl sys_physics_update
                             15 .globl entity_x
                             16 .globl entity_vx
                             17 .globl entities
                             18 .globl last_entity_pos_entities
                             19 .globl entity_prevptr
                             20 .globl man_set4Destruction_entity
                             21 
                             22 .area _CODE
                             23 
   4134                      24 sys_physics_update:
   4134 21 B5 42      [10]   25     ld  hl, #entities
   4137 22 F3 42      [16]   26     ld (where_I_am),hl
   413A 7D            [ 4]   27     ld a,l
   413B C6 36         [ 7]   28     add #54
   413D 6F            [ 4]   29     ld l, a
   413E EB            [ 4]   30     ex de, hl
                             31 
   413F                      32         jump:
   413F 01 00 00      [10]   33         ld   bc, #0x0000
   4142 ED 4B F3 42   [20]   34         ld   bc, (where_I_am)
   4146 DD 21 00 00   [14]   35         ld   ix, #0x000
   414A DD 09         [15]   36         add  ix, bc 
                             37 
   414C DD 7E 00      [19]   38         ld a, (ix)
   414F FE 01         [ 7]   39         cp #1
   4151 20 18         [12]   40         jr nz, dontReduceX
                             41 
   4153 06 00         [ 7]   42         ld b,#0x00
   4155 DD 7E 01      [19]   43         ld  a, +1(ix)                   ;;a got the X of the entity
   4158 DD 77 05      [19]   44         ld  +5(ix),a
   415B DD 96 03      [19]   45         sub +3(ix)                    ;; add the speed
                             46         
   415E DC AD 40      [17]   47         call c, man_set4Destruction_entity          ;; returb b value 00, didnt do anything --FF set it for destroy
   4161 67            [ 4]   48             ld h, a
   4162 78            [ 4]   49             ld  a, b
   4163 FE FF         [ 7]   50             cp #0xFF
   4165 28 04         [12]   51             jr  z, willbedestroied              ;; this entity will be destroied
   4167 7C            [ 4]   52             ld a, h
   4168 DD 77 01      [19]   53         ld  +1(ix), a   
   416B                      54         willbedestroied:
   416B                      55         dontReduceX:
                             56 
                             57                       ;; put the added speed to the X position
...
Hexadecimal [16-Bits]
                             ...
                             60    
                             61 
   416B 21 F3 42      [10]   62         ld hl, #where_I_am
                             63         .rept 6
                             64             inc (hl)
                             65         .endm
   416E 34            [11]    1             inc (hl)
   ...
   4173 34            [11]    1             inc (hl)
                             66 
                             67 
   4174 ED 4B F3 42   [20]   68     ld bc, (where_I_am)
   4178 79            [ 4]   69     ld  a, c
   4179 BB            [ 4]   70     cp  e               ;;#checking if "WIam" is the same,
                             71                                     ;; that means i am in already updated
                             72                                     ;; the last entity
   417A 20 C3         [12]   73     jr  nz, jump                    ;; if i am not in the last entity, do next entity
                             74 
   417C 78            [ 4]   75     ld a, b
   417D BA            [ 4]   76     cp d
   417E 20 BF         [12]   77     jr nz, jump                     ;; checking if last entity and where i am in same place, finishes the update
                             78                                     ;; Loop of all entities
                             79     
                             80 
                             81 
                             82 
