...
Hexadecimal [16-Bits]
                              ...
                              8 
                              9 
                             10 .globl e_type_star
                             11 
                             12 
                             13 .globl cpct_disableFirmware_asm
                             14 .globl cpct_getScreenPtr_asm
                             15 .globl man_create_entity
                             16 .globl cpct_getRandom_mxor_u8_asm
                             17 .globl sys_generator_newStar
                             18 .globl man_search_for_space
                             19 .area _CODE
                             20 
   410F                      21 sys_generate_random:
   410F D6 46         [ 7]   22     sub #70
   4111 C9            [10]   23 ret
                             24 
   4112                      25 sys_generator_newStar:
                             26 
   4112 CD 3B 42      [17]   27     call cpct_getRandom_mxor_u8_asm    ;; generate random number of 200
   4115 7D            [ 4]   28     ld a, l
   4116 2E C7         [ 7]   29     ld l, #199
   4118 BD            [ 4]   30     cp l
   4119 D4 0F 41      [17]   31     call nc, sys_generate_random
                             32 
   411C 5F            [ 4]   33     ld e, a                           ;; save the number in E
   411D D5            [11]   34     push de
                             35 
                             36 
                             37 
   411E CD 3B 42      [17]   38     call cpct_getRandom_mxor_u8_asm      ;; generate random number of 3
   4121 7D            [ 4]   39     ld a, l
   4122 E6 03         [ 7]   40     and a, #03
                             41 
                             42              
                             43                                        ;; put the random number negative
   4124 47            [ 4]   44     ld b, a
   4125 04            [ 4]   45     inc b                               ;; reduce the number by 1, to not get a 0 (-1,-3)
                             46     
   4126 3A A5 42      [13]   47     ld a, (e_type_star)
   4129 4F            [ 4]   48     ld c, a
   412A C5            [11]   49     push bc
                             50 
   412B CD CC 40      [17]   51     call man_search_for_space
   412E C1            [10]   52         pop bc
   412F D1            [10]   53         pop de
   4130 CD 28 40      [17]   54     call man_create_entity
                             55    
                             56 
                             57 
