...
Hexadecimal [16-Bits]
                              ...
                              3 
                              4 .area _DATA
   42F9 FF FF                 5 where_to_draw:  .dw #0xffff              ;; place where i will draw
   42FB 00 00                 6 where_I_am:     .dw #0x0000                ;; this one is for move for the entities array calculating
   42FD FF                    7 pos_x:          .db #0xFF
   42FE FF                    8 pos_y:          .db #0xFF
   42FF FF                    9 color:          .db #0xFF
   4300 FF                   10 prevptr:        .db #0xFF
                             11 
   4301 00 00                12 finish_entities: .dw #0x0000
                             13 ;; variables
                             14 .globl entity_x
                             15 .globl entity_y
                             16 .globl entity_prevptr
                             17 .globl entity_color
                             18 .globl last_entity_pos_entities
                             19 .globl entities
                             20 ;; methods
                             21 .globl sys_render_update
                             22 .globl sys_render_init
                             23 ;;video
                             24 .globl cpct_disableFirmware_asm
                             25 .globl cpct_getScreenPtr_asm
                             26 .globl cpct_setVideoMode_asm
                             27 .globl cpct_setPALColour_asm
                             28 
                             29 .area _CODE
                             30 
   4182                      31 sys_render_1Entity::
                             32 
   4182 DD 7E 00      [19]   33     ld a, (ix)
   4185 FE 00         [ 7]   34     cp #0
   4187 28 26         [12]   35     jr z, leave
                             36     
   4189 DD 7E 05      [19]   37     ld a, +5(ix)      
                             38                                 ;; ENTITY POSITION + 5
   418C FE FF         [ 7]   39     cp #0xFF                      ;; Checking if preptr is 0 or not
   418E 28 0D         [12]   40     jr z, salta_render          ;; if prevptr is == 0
                             41 
   4190 11 00 C0      [10]   42     ld de, #0xC000
   4193 4F            [ 4]   43     ld c, a
   4194 DD 7E 02      [19]   44     ld a, +2(ix)
   4197 47            [ 4]   45     ld b, a
   4198 CD 61 42      [17]   46     call cpct_getScreenPtr_asm 
                             47     
   419B 36 00         [10]   48     ld  (hl), #0x00
                             49 
   419D                      50     salta_render:
                             51 
                             52     ;;(2B DE) screen_start	Pointer to the start of the screen (or a backbuffer)
                             53     ;;(1B C ) x	[0-79] Bytes-aligned column starting from 0 (x coordinate,
                             54     ;;(1B B ) y	[0-199] row starting from 0 (y coordinate) in bytes)
   419D 11 00 C0      [10]   55         ld de, #0xC000
   41A0 3A FD 42      [13]   56         ld a,(pos_x)
   41A3 4F            [ 4]   57         ld c, a
...
Hexadecimal [16-Bits]
   ...
   41A4 3A FE 42      [13]   58         ld a, (pos_y)
   41A7 47            [ 4]   59         ld b, a
   41A8 CD 61 42      [17]   60         call cpct_getScreenPtr_asm          ;; in HL I have the position 
                             61                                         ;;  of where i need to paint
   41AB 3A FF 42      [13]   62         ld a, (color)
   41AE 77            [ 7]   63         ld  (hl), a
                             64     
   41AF                      65     leave:
                             66 
   41AF C9            [10]   67 ret
                             ...
                             69 
                             70 
   41B0                      71 sys_render_update:
                             72               ;;#memory adress of the entities array
   41B0 21 B5 42      [10]   73     ld  hl, #entities
   41B3 22 FB 42      [16]   74     ld (where_I_am),hl
   41B6 7D            [ 4]   75     ld a,l
   41B7 C6 36         [ 7]   76     add #54
   41B9 6F            [ 4]   77     ld l, a
   41BA 22 01 43      [16]   78     ld (finish_entities), hl
                             79    
                             80 
   41BD                      81     jump:
                             82 
   41BD 01 00 00      [10]   83         ld   bc, #0x0000
   41C0 ED 4B FB 42   [20]   84         ld   bc, (where_I_am)
   41C4 DD 21 00 00   [14]   85         ld   ix, #0x000
   41C8 DD 09         [15]   86         add  ix, bc 
                             87 
                             88         
                             89 
   41CA DD 7E 01      [19]   90         ld  a, +1(ix)                   ;;a got the X of the entity
   41CD 32 FD 42      [13]   91         ld  (pos_x), a
   41D0 DD 7E 02      [19]   92         ld  a, +2(ix)                   ;;a got the Y of the entity
   41D3 32 FE 42      [13]   93         ld  (pos_y),a
   41D6 DD 7E 04      [19]   94         ld  a, +4(ix)                   ;;a got the Color of the entity
   41D9 32 FF 42      [13]   95         ld  (color), a
   41DC CD 82 41      [17]   96         call sys_render_1Entity
                             97         
                             98 
                             99                       ;; put the added speed to the X position
                            100                         
                            101         
                            102    
                            103 
   41DF 21 FB 42      [10]  104         ld hl, #where_I_am
                            105         .rept 6
                            106             inc (hl)
                            107         .endm
   41E2 34            [11]    1             inc (hl)
...
Hexadecimal [16-Bits]
   ...
   41E7 34            [11]    1             inc (hl)
                            108 
   41E8 2A 01 43      [16]  109     ld hl,(finish_entities)
   41EB EB            [ 4]  110     ex de, hl
   41EC ED 4B FB 42   [20]  111     ld bc, (where_I_am)
   41F0 79            [ 4]  112     ld  a, c
   41F1 BB            [ 4]  113     cp  e               ;;#checking if "WIam" is the same,
                            114                                     ;; that means i am in already updated
                            115                                     ;; the last entity
   41F2 20 C9         [12]  116     jr  nz, jump                    ;; if i am not in the last entity, do next entity
                            117 
   41F4 78            [ 4]  118     ld a, b
   41F5 BA            [ 4]  119     cp d
   41F6 20 C5         [12]  120     jr nz, jump                     ;; checking if last entity and where i am in same place, finishes the update
                            121                                     ;; Loop of all entities
                            122     
                            123 
                            124 
                            125 
   ...
   41F8 C9            [10]  131 ret
                            ...
                            133 
                            134 
   41F9                     135 sys_render_init:
   41F9 21 B5 42      [10]  136     ld hl, #entities
   41FC 22 FB 42      [16]  137     ld (where_I_am), hl
   41FF 0E 00         [ 7]  138     ld c, #0x00
   4201 CD 16 42      [17]  139     call	cpct_setVideoMode_asm ;; video mode 0
                            140 
                            141     ;; (1B L) pen	[0-16] Index of the palette colour to change.  Similar to PEN Number in BASIC.
                            142     ;;(1B H) hw_ink	[0-31] New hardware colour value for the given palette index.
                            143     ;;Assembly 
   4204 21 10 14      [10]  144     ld	hl, #0x1410
   4207 CD 0C 42      [17]  145     call cpct_setPALColour_asm              ;; Set border to HW_BLACK
   420A C9            [10]  146 ret
                            147 
   420B                     148 sys_borrar_star::
                            149 
                            150 
                            151 
                            152 
